...
function preorderTraversal(node, steps, path = []) {
    ...
    const leftSteps = preorderTraversal(node.left, [], [...path, node]);
    ...
    const rightSteps = preorderTraversal(node.right, [], [...path, node]);
